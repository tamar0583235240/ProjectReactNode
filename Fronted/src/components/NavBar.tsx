...
const NavBar = () => {
    ...
    // עדכון פונקציית הלחיצה על כפתור ההרשמה
    ...
    // פונקציה לפתיחת פופאפ התחברות
    const handleSignInClick = () => {
        setOpenSignInDialog(true)
    }

    // פונקציה לסגירת פופאפ התחברות
                                ...
                                {pages.map((page) => (
                                    <MenuItem key={page} onClick={handleCloseNavMenu}>
                                        <Typography sx={{ textAlign: 'center' }}>
                                            <Link to={`/${page === 'HomePage' ? '' : page}`} style={{ textDecoration: 'none', color: 'inherit' }}>{page}</Link>
                                        </Typography>
                                    </MenuItem>
                                ))}
                            </Menu>
